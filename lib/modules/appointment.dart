...
class _AppointmentState extends State<Appointment> {
  ...
  Future insertToDatabaseAppointments() async {
    print('---------------------');
    return await db.transaction(
          (txn) async {
        await txn.rawInsert(
            'INSERT INTO appointments (AppointmentDate,Message , DoctorName) VALUES("5:00 pm","يحتاج عودة","Wael")')
            .then(
              (value) {
  ...
  void getFromDBAppointment()async {
